...
assert.match(authJavaSource, /\/user-api-key\/device\.json/)
assert.match(authJavaSource, /\/user-api-key\/device\/poll\.json/)
assert.doesNotMatch(authJavaSource, /\/user-api-key\/new/)
assert.match(authJavaSource, /application\/json; charset=UTF-8/)
