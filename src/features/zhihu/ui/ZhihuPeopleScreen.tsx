...
import { Ban, Loader2, MessageCircle, UserPlus, UserRound } from 'lucide-react'
...
import { ZhihuContentRow, ZhihuErrorBanner, ZhihuLoadingState, ZhihuSurface } from './ZhihuUi'
        ...
        <header className="mb-5 border-b border-haze/55 pb-5">
          <div className="flex items-start gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="truncate font-display text-[24px] font-medium leading-tight text-paper">{profile.name}</h1>
